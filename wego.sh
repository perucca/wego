...
sudo docker run --network='wego-network' --name database -v /home/michel/mysql-data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=password -e MYSQL_DATABASE=wego -d mysql:5.7.23
